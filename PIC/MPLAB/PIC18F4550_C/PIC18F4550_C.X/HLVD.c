...
//HLVD interrupt config function
void interrupt_config(void)
{
    IPEN=0;   //disable priorities
    GIE=1;     //global interrupt enable
    PEIE=1;      //peripheral interrupt enable
    HLVDIF=0;        //HLVD interrupt flag
    HLVDIE=1;       //enable HLVD interrupt
}
//ISR vector function
void interrupt isr(void)
{
...
void hlvd_isr(void)
{
    RD1=1;          //indicate low voltage detect
    HLVDIF=0;      //clear interrupt
}
