...
void main()
{
    ...
    {
        unsigned char i;
        for(i=0x80; i<0x90; i++)                //0x80 is the address of the 1st 5x8 matrix on 1st line on LCD; repeat till end of 1st line
        {
            ...
            lcd_cmd_transmit(i);
            lcd_cmd_transmit(0x06);
            lcd_data_transmit(0x01);
            delay(150);
            lcd_cmd_transmit(i);
            lcd_cmd_transmit(0x06);
            lcd_data_transmit(0x02);
            delay(150);
            lcd_cmd_transmit(i);
            lcd_cmd_transmit(0x06);
            lcd_data_transmit(0x03);
            delay(150);
            lcd_cmd_transmit(i);
            lcd_cmd_transmit(0x06);
            lcd_data_transmit(0x04);
            delay(150);
        }
        lcd_cmd_transmit(0x01);         //clear display & repeat
    }
}
