...
SOPCINFO_FILE := G:/Altera/15.0/Nios/practica4/mi_nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1002040
SOPC_SYSID_FLAG += --sidp=0x1002040
ELF_PATCH_FLAG  += --sidp 0x1002040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1432137269
SOPC_SYSID_FLAG += --timestamp=1432137269
ELF_PATCH_FLAG  += --timestamp 1432137269
